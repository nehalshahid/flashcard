        ...
        const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'You are a flashcard generator. You only respond with valid JSON arrays. Write detailed answers of 2-3 sentences each — explain the concept fully, state why it matters, and include a concrete example.Answer should not be more than 2 lines. Never add any text before or after the JSON.'
                    },
